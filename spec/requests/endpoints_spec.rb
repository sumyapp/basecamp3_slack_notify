    ...
    context 'comment created' do
      ...
      it "notifies to slack" do
        ...
        expect(notifier).to have_received(:post).with(
          text: ":speech_balloon: Comment created in Project <https://3.basecamp.com/120348923894/projects/8310498/|RuboCop> Todo <https://3.basecamp.com/120348923894/buckets/8310498/todos/290347|Heredoc delimiter lowercase> by Masataka Pocke Kuwabara\n",
          attachments: [{
